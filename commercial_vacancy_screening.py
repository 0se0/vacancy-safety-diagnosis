...
공실 후보 주소를 스크리닝한다. verification_scan.py가 25개구 870건 표본으로 했던
...
verification_scan.py가 25개구 870건 표본으로 했던 "등록 vs 실제" 비교를 서울 25개구 상업용 건물 전체({ledger_total:,}건) 규모로 확장한 버전이다.<br>
