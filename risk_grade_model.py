...
★ 전력사용량 추세를 세 번째 신호로 추가(2026-09-01, market_energy_matching.py로
  2026-09-02에 범위 확대) — 상가정보 API를 스캔해 얻은 실제 건물명(bldNm)을 48개
  ...
  1차(8개구: 강남·마포·광진·종로·중구·영등포·성동·강북) 4곳 + 2차(10개구: 용산·
  동대문·관악·성북·도봉·노원·강서·동작·송파·중랑) 4곳 = 총 8/48곳.
  나머지 40곳은 (a) 아직 안 스캔한 구(성북 일부, 서초·구로·양천·은평·금천·강동
  등 상권 없는 구는 제외됨)에 있거나 (b) 이름이 겹쳐 안전 매칭 조건을 못 채움.
...
# 8곳만 안전하게 매칭됨(위 설명 참고). 값 = 전기사용량 전반기(2024.01~2025.01)
