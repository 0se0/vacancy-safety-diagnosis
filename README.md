...
| 노후 대형상가·전통시장 안전등급(A~D) | **277곳** 산출 (D48·C64·B109·A56, 지도 표시는 좌표 확보된 48곳) |
...
flowchart LR
    ...
    subgraph B["체인 B · 상권 등급"]
        ...
        B2 --> B3["A~D 안전등급 277곳<br/>지도 표시는 좌표 확보된 48곳만"]
    end
...
- 안전등급 지도는 좌표를 수작업으로 확보한 48곳만 표시함 — 나머지 229곳은
  등급은 산출됐지만 위경도가 없어 지도에는 안 나옴
