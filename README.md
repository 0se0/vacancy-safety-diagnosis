...
| 노후 대형상가·전통시장 안전등급(A~D) | **277곳** 산출 (D48·C64·B109·A56, 지도 표시는 좌표 확보된 155곳) |
...
flowchart LR
    ...
    subgraph B["체인 B · 상권 등급"]
        ...
        B2 --> B3["A~D 안전등급 277곳<br/>지도 표시는 좌표 확보된 155곳"]
    end
...
- 안전등급 지도 마커는 155/277곳만 표시함 — 원래 48곳은 수작업 근사 좌표,
  나머지 229곳 중 107곳은 OpenStreetMap Nominatim으로 지오코딩해 채웠지만
  122곳은 검색 결과가 없거나 서울 밖으로 잡혀서 미확보 상태로 남김(등급은
  277곳 전부 산출됨, 지도에만 안 나옴). 155곳도 정밀 지번 좌표가 아니라
  "그 이름으로 지도 서비스에 등록된 가장 가까운 지점" 근사치
