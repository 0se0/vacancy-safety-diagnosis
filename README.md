...
| 노후 대형상가·전통시장 안전등급(A~D) | **277곳** 산출 (D48·C64·B109·A56, 지도 표시는 좌표 확보된 171곳) |
...
flowchart LR
    ...
    subgraph B["체인 B · 상권 등급"]
        B1["점포수 시계열<br/>순증감률·폐업률 (277곳)"] --> B2["+ 전력사용량 추세<br/>(8/277곳)"]
...
- 상권 A~D 등급 중 전력사용량 신호까지 반영된 곳은 277곳 중 8곳뿐 — 나머지는
